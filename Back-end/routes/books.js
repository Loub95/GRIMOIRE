...
router.post("/", auth, multer, booksCtrl.createBook); // Route pour créer un livre (authentification requise, gestion des fichiers avec multer, manipulation des images avec sharp)
router.get("/:id", booksCtrl.getOneBook); // Route pour récupérer un livre spécifique
router.put("/:id", auth, multer, booksCtrl.modifyBook); // Route pour modifier un livre spécifique (authentification requise, gestion des fichiers avec multer, manipulation des images avec sharp)
